    ...
    <section id="rentals" className="py-20 bg-[#fbfdfc]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="dark-luxury-bg rounded-[2.5rem] p-6 sm:p-10 lg:p-12 text-white shadow-2xl relative overflow-hidden border border-[#1b4e3c]">
          ...
          <div className="absolute bottom-0 left-10 w-72 h-72 bg-[#FFDF00]/10 rounded-full blur-3xl pointer-events-none" />

          {/* Header Row */}
          <div className="flex flex-col md:flex-row md:items-end justify-between mb-10 relative z-10">
            <div>
              <span className="text-[11px] font-bold tracking-widest text-[#FFDF00] uppercase bg-[#F5F2E6]/10 backdrop-blur-md px-3 py-1 rounded-full mb-3 inline-block">
                VEHICLE RENTALS
              </span>
            ...
            <div className="mt-4 md:mt-0 flex items-center gap-3">
              <button
                ...
                className="bg-[#F5F2E6]/10 hover:bg-[#F5F2E6]/20 backdrop-blur-md border border-white/20 text-white px-5 py-2 rounded-full text-xs font-semibold tracking-wide transition-all cursor-pointer"
              >
                View All Vehicles
              </button>
              <button
                ...
                className="w-9 h-9 rounded-full bg-[#F5F2E6]/10 hover:bg-[#F5F2E6]/25 border border-white/15 flex items-center justify-center text-white transition-all cursor-pointer"
              >
          ...
          >
            {VEHICLES.map((vehicle) => (
              <div
                ...
                className="group flex-shrink-0 w-[260px] sm:w-[280px] bg-[#0c241c]/90 hover:bg-[#113328] backdrop-blur-md rounded-3xl p-5 border border-white/10 hover:border-[#FFDF00]/50 shadow-lg hover:shadow-2xl transition-all duration-300 flex flex-col justify-between cursor-pointer snap-start"
              >
                ...
                <div>
                  ...
                  <div className="grid grid-cols-3 gap-2 py-3 border-y border-white/10 text-gray-300 text-xs mb-4">
                    <div className="flex items-center gap-1.5 justify-center">
                      <Users className="w-3.5 h-3.5 text-[#FFDF00]" />
                      <span>{vehicle.passengers}</span>
                    </div>
                    <div className="flex items-center gap-1.5 justify-center border-x border-white/10">
                      <Briefcase className="w-3.5 h-3.5 text-[#FFDF00]" />
                      <span>{vehicle.luggage}</span>
                    </div>
                    <div className="flex items-center gap-1.5 justify-center">
                      <Cog className="w-3.5 h-3.5 text-[#FFDF00]" />
                ...
                <div className="flex items-center justify-between pt-1">
                  <div>
                    <div className="text-[13px] sm:text-sm font-bold text-[#FFDF00]">
                      {formatPrice(vehicle.pricePerDayLKR)}
                    </div>
                    <div className="text-[10px] text-gray-400">/ Day (Self or Driver)</div>
                  </div>

                  <span className="w-7 h-7 rounded-full bg-[#F5F2E6]/10 group-hover:bg-[#FFDF00] text-white group-hover:text-[#072118] flex items-center justify-center transition-all duration-200">
            ...
            {guarantees.map((item, idx) => {
              ...
              return (
                <div key={idx} className="flex items-center gap-2.5">
                  <div className="w-6 h-6 rounded-full bg-[#FFDF00]/20 flex items-center justify-center text-[#FFDF00] shrink-0">
